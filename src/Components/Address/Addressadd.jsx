                        ...
                        <div className="Address-head"> 
                           ...
                           <div className="nameAddressinform">
                                ...
                                <div className="Address-managename">
                                    {textorin ?(<text className="class-getname">{data_all?.map(item => item.cus_name).join(', ')}</text>):(<div className="input-change-name"><input type="text" className='nameinform-input' onChange={(e)=>{setname(e.target.value)}} />
                                    
                                    

                                    </div>)}
                                    {textorin?(<img src={pencill} alt="" className="Address-pencil" onClick={()=>setss(!textorin)}/>):(<div><img src={Acceptlogo} alt=" " className="Address-button-ck" onClick={()=>{altername();setss(!textorin);recieveData(data_all?.map(item => item.cus_email).join(', '));window.location.reload();}}/>
                                    <img src={rejectlogo} alt="" className="Address-button-ck" onClick={()=>{setname(null);setss(!textorin);}}/></div>)}
